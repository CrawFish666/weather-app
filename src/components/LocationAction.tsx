...
export function LocationAction({
	...
	return (
		<div className="text-white relative inline-flex items-center ">
			<button onClick={onClick} className="bg-gray-700 cursor-pointer flex rounded-full transition-all duration-300 ease-out items-center w-10 overflow-hidden whitespace-nowrap  hover:w-[min(96vw,100%)]">
